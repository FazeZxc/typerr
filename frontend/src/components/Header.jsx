...
export const Header = () => {
  ...
  return (
    <div className="pt-2 px-8 flex flex-row justify-between items-end">
      ...
      <div className="h-12 w-12 flex flex-row items-center justify-center hover:bg-[#272727] rounded-2xl cursor-pointer">
        <svg
          onClick={() => {
            navigate("/auth");
          }}
